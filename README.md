...
All strategies, along with the training results, are documented in the notebook and summarized in the PDF file included in the repository (project slides).
